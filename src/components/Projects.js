...
const Projects = () => {
  return (
    <section id="projets" className="py-24 bg-gradient-to-b from-gray-50 via-white to-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {projects.map((project, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group relative border border-gray-100"
            >
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center space-x-6 opacity-0 group-hover:opacity-100 transition-all duration-500">
                  <a
                    ...
                    className="text-white hover:text-indigo-400 transform hover:scale-125 transition-transform duration-300"
                  >
                    <FaGithub size={30} />
                  </a>
                  <a
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 min-h-[100px] leading-relaxed">
                  {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs font-semibold py-1 px-3 bg-indigo-100 text-indigo-800 rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
